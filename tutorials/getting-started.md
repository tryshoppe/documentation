...
## Displaying your basket

Unfortunately, we haven't yet done anything to display the contents of the basket so although we
...
I'm sure people will forget what they put in their basket, so we should add a view which
